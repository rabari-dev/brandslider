...
namespace Rabari\BrandSlider\Model\ResourceModel\Brand;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init('Rabari\BrandSlider\Model\Brand', 'Rabari\BrandSlider\Model\ResourceModel\Brand');
    }
    ...
    public function joinBrandSliderTitle()
    {
        $this->getSelect()->joinLeft(
            ['brandsliderTable' => $this->getTable('Rabari_BrandSlider_brandslider')],
