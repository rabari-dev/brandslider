...
namespace Rabari\BrandSlider\Controller\Adminhtml;
 ...
 */
abstract class Brand extends \Rabari\BrandSlider\Controller\Adminhtml\AbstractAction
{
    ...
    {
        return $this->_authorization->isAllowed('Rabari_BrandSlider::brandslider_brands');
    }
