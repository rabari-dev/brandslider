        ...
        if ($data = $this->getRequest()->getPostValue()) {
            ...
            if ($isUpload) {
                if ($fileName == '') {
                    ...
                    $data['image'] = $this->uploadImage('image', $this->imageModel->getBaseDir(\Rabari\BrandSlider\Model\Brand\Image::BASE_MEDIA_PATH), $data);
                }
            }
    ...
    public function uploadImage($input, $destinationFolder, $data)
    {
        try {
            ...
            if (isset($data[$input]['delete'])) {
                ...
                return \Rabari\BrandSlider\Model\Brand\Image::BASE_MEDIA_PATH . $result['file'];
            }
        } catch (\Exception $e) {
